...
import static com.ly.travel.institute.proxy.server.impl.ConnectionState.*;
...
abstract class ProxyConnection<I extends HttpObject> extends SimpleChannelInboundHandler<Object> {
   ...
   * @param runsAsSslClient determines whether this connection acts as an SSL client or server (determines who does the
   *        handshake)
   */
   ...
   * 
   * @return {@code Future<Void>} for when we're done disconnecting. If we weren't connected, this returns null.
   */
   ...
   * 
   * <p>
   * Note - we don't care what kind of IdleState we got. Thanks to <a href="https://github.com/qbast">qbast</a> for
   * pointing this out.
   * </p>
   */
  @Override
   ...
   */
  @Sharable
  protected static abstract class RequestWrittenMonitor extends ChannelOutboundHandlerAdapter {
    @Override
    public void write(ChannelHandlerContext ctx, Object msg, ChannelPromise promise) throws Exception {
