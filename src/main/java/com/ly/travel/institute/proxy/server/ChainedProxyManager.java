...
public interface ChainedProxyManager {
  ...
  /**
   * <p>
   * Based on the given httpRequest, add any {@link ChainedProxy}s to the list that should be used to process the request.
   ...
   * {@link ChainedProxyAdapter#FALLBACK_TO_DIRECT_CONNECTION} to the end of the list.
   * </p>
   * 
   * <p>
   ...
   * </p>
   */
  void lookupChainedProxies(HttpRequest httpRequest, Queue<ChainedProxy> chainedProxies, ClientDetails clientDetails);
}
