...
public interface SslEngineSource {
  ...
  /**
   * Returns an {@link SSLEngine} to use for a client connection from LittleProxy to the upstream server. *
   * 
   * Note: Peer information is needed to send the server_name extension in handshake with Server Name Indication (SNI).
   * 
