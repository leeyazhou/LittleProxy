...
abstract class ConnectionFlowStep {
   ...
   * continues with the flow. Other implementations may choose to not continue and instead wait for a message or something
   * like that.
   */
  ...
  /**
   * <p>
   * Any messages that are read from the underlying connection while we're at this step of the connection flow are passed
   * to this method.
   * </p>
   * 
   * <p>
